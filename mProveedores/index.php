								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
										<div class="form-group">
											...
											<input type="text" id="proveedor" class="form-control " autofocus="" required="" placeholder="Escribe el nombre del proveedor">
										</div>
									</div>
									...
									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
										<div class="form-group">
											...
											<input type="text" id="clave" class="form-control " autofocus="" required="" placeholder="Escribe la clave del proveedor">
										</div>
									</div>
								</div>
								<div class="row">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="form-group">
							<label for="proveedorE">Nombre del Proveedor:</label>
							<input type="text" id="proveedorE" class="form-control " autofocus="" required="" placeholder="Escribe el nombre del proveedor">
						</div>
					</div>

					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="form-group">
							<label for="claveE">Clave del Proveedor:</label>
							<input type="text" id="claveE" class="form-control " autofocus="" required="" placeholder="Escribe la clave del proveedor">
						</div>
					</div>
				</div>
	      </div>
