...
$titulo="Registros de entrada y salida de Proveedores";
$opcionMenu="A";
$fecha=date("Y-m-d"); 
 ?>
<!DOCTYPE html>
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<div class="form-group">
											<label for="nombre">Municipios:</label>
											<input type="text" id="municipio" class="form-control " autofocus="" required="" placeholder="Escribe el Municipio">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
										<button type="button" id="btnLista" class="btn btn-login  btn-flat  pull-left">Lista de Municipios</button>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="form-group">
							<label for="nombreE">Municipio:</label>
							<input type="text" id="municipioE" class="form-control " autofocus="" required="" placeholder="Escribe el Municipio">
						</div>
					</div>
				</div>
	      </div>
