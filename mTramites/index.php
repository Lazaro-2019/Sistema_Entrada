				    ...
				    <div class="container-fluid">
				        <section id="alta" style="display: none">
            				<form id="frmAlta">
								<div class="row">
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<div class="form-group">
											<label for="nombre">Tramite:</label>
											<input type="text" id="nombre" class="form-control " autofocus="" required="" placeholder="Escribe el Tramite">
										</div>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
										<div class="form-group">
											<label for="pertenece">Pertenece a:</label>
											<select  id="pertenece" class="select2 form-control " style="width: 100%">
								...
								<div class="row">
									<div class="col-lg-12">
										<button type="button" id="btnLista" class="btn btn-login  btn-flat  pull-left">Lista de Tramites</button>
	  ...
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
				...
				<input type="hidden" id="idDepartamentoE">
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-8 col-lg-8">
						<div class="form-group">
							<label for="nombreE">Tramite:</label>
							<input type="text" id="nombreE" class="form-control" autofocus="" required="" placeholder="Escribe el Tramite">
						</div>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
						<div class="form-group">
							<label for="perteneceE">Pertenece a:</label>
							<select  id="perteneceE" class="select2 form-control " style="width: 100%">
							</select>
						</div>
					</div>
					<div class="col-xs-6 col-sm-12 col-md-12 col-lg-12">
						<div class="form-group">
							<label for="departamentoE">Departamento:</label>
							<select  id="departamentoE" class="select2 form-control " style="width: 100%">
							</select>
						</div>
					</div>
				</div>
