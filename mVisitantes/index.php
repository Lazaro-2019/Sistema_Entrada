								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
										<div class="form-group">
											<label for="visitante">Nombre del Visitantes:</label>
											<input type="text" id="visitante" class="form-control " autofocus="" required="" placeholder="Escribe el nombre del visitante">
										</div>
									</div>

									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
										<div class="form-group">
											<label for="clave">Clave del Visitante:</label>
											<input type="text" id="clave" class="form-control " autofocus="" required="" placeholder="Escribe la clave del visitante">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
										<button type="button" id="btnLista" class="btn btn-login  btn-flat  pull-left">Lista de Visitantes</button>
	  ...
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title">Editar Visitante</h4>
	      </div>
	      <div class="modal-body">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="form-group">
							<label for="visitanteE">Nombre del Visitante:</label>
							<input type="text" id="visitanteE" class="form-control " autofocus="" required="" placeholder="Escribe el nombre del visitante">
						</div>
					</div>

					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="form-group">
							<label for="claveE">Clave del Visitante:</label>
							<input type="text" id="claveE" class="form-control " autofocus="" required="" placeholder="Escribe la clave del visitante">
						</div>
					</div>
				</div>
	      </div>
